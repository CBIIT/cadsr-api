...
package gov.nih.nci.cadsrapi.applicationService.impl;
...
import gov.nih.nci.cadsrapi.util.xml.Validator;
...
public class caDSRAPIServiceImpl extends ApplicationServiceImpl implements caDSRAPIService{
	...
	private static Logger log = Logger.getLogger(caDSRAPIServiceImpl.class.getName());

	public caDSRAPIServiceImpl(ClassCache classCache) {
		super(classCache);
	}
