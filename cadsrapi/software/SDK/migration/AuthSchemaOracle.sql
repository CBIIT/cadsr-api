...
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_APPLICATION TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_GROUP TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_PG_PE TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_PRIVILEGE TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_FILTER_CLAUSE TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_PROTECTION_ELEMENT TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_PROTECTION_GROUP TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_ROLE TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_ROLE_PRIVILEGE TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_USER TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_USER_GROUP TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_USER_GROUP_ROLE_PG TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_USER_PE TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_MAPPING TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_PASSWORD_HISTORY TO CADSR_API;
/
GRANT SELECT, INSERT, UPDATE, DELETE ON CADSR_API.CSM_CONFIGURATION_PROPS TO CADSR_API;
/

CREATE SYNONYM CADSR_API.CSM_APPLICATION FOR SBREXT.CSM_APPLICATION
/

CREATE SYNONYM CADSR_API.CSM_GROUP FOR SBREXT.CSM_GROUP
/

CREATE SYNONYM CADSR_API.CSM_PG_PE FOR SBREXT.CSM_PG_PE
/

CREATE SYNONYM CADSR_API.CSM_PRIVILEGE FOR SBREXT.CSM_PRIVILEGE
/

CREATE SYNONYM CADSR_API.CSM_FILTER_CLAUSE FOR SBREXT.CSM_FILTER_CLAUSE
/

CREATE SYNONYM CADSR_API.CSM_PROTECTION_ELEMENT FOR SBREXT.CSM_PROTECTION_ELEMENT
/

CREATE SYNONYM CADSR_API.CSM_PROTECTION_GROUP FOR SBREXT.CSM_PROTECTION_GROUP
/

CREATE SYNONYM CADSR_API.CSM_ROLE FOR SBREXT.CSM_ROLE
/

CREATE SYNONYM CADSR_API.CSM_ROLE_PRIVILEGE FOR SBREXT.CSM_ROLE_PRIVILEGE
/

CREATE SYNONYM CADSR_API.CSM_USER FOR SBREXT.CSM_USER
/

CREATE SYNONYM CADSR_API.CSM_USER_GROUP FOR SBREXT.CSM_USER_GROUP
/

CREATE SYNONYM CADSR_API.CSM_USER_GROUP_ROLE_PG FOR SBREXT.CSM_USER_GROUP_ROLE_PG
/

CREATE SYNONYM CADSR_API.CSM_USER_PE FOR SBREXT.CSM_USER_PE
/

CREATE SYNONYM CADSR_API.CSM_MAPPING FOR SBREXT.CSM_MAPPING
/

CREATE SYNONYM CADSR_API.CSM_PASSWORD_HISTORY FOR SBREXT.CSM_PASSWORD_HISTORY
/

CREATE SYNONYM CADSR_API.CSM_CONFIGURATION_PROPS FOR SBREXT.CSM_CONFIGURATION_PROPS
/
