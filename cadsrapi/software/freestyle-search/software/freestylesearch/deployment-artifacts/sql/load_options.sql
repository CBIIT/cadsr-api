...
using (
          select 'CADSRAPI' as tool_name, 'URL' as property, 'http://cadsrapi-dev.nci.nih.gov/cadsrapi40' as value, 'The caDSR API URL.' as description from dual
...
merge into sbrext.tool_options_view_ext s
using (
          select 'FREESTYLE' as tool_name , 'URL' as property, 'http://freestyle-dev.nci.nih.gov' as value, '' as ua_name, 'The URL to the Freestyle Search Engine browser interface.' as description from dual
...
union select 'FREESTYLE' as tool_name , 'VERSION' as property, '4.0.1.0.201312161152' as value, '' as ua_name, 'The version identification for the current Freestyle Search Engine.' as description from dual
) t
on (s.tool_name = t.tool_name and s.property = t.property)
